...
exports.getPosts = async (req, res, next) => {
  ...
  try {
    ...
    const posts = await Post.find()
      //since the key 'creator' only holds the id of the user, populute takes that user id stored in 'creator'
      //and includes all the creator raw data
      .populate("creator")
...
exports.updatePost = async (req, res, next) => {
  ...
  try {
    //populate() => since the key 'creator' only holds the id of the user, populute takes that user id stored in 'creator'
    //and includes all the creator raw data
